...
class Logger_InternalError(SyntaxError):
    pass


def message(
    _string: str, *, no_print: bool = False, auto_highlight: bool = False
) -> None:
    raise Logger_InternalError


def info(_string: str, *, no_print: bool = False, auto_highlight: bool = False) -> None:
    raise Logger_InternalError
...
for mode in loggers:
    exec(
        f"def {mode}(_string:str,*,no_print:bool=False,auto_highlight:bool=False):log(__logMode(),_string,no_print=no_print,auto_highlight=auto_highlight)"
    )
...
def create(
    name: str,
    fore_color: str = "rgb(255, 255, 255)",
